...
if __name__ == '__main__':
    ...
    predicted_cost = linear_regression.predict(data_from_csv_file[['close']][-projection:])

    forecast_price_accuracy = linear_regression.score(x_array, y_array)
    print("Forecast price accuracy", forecast_price_accuracy)
